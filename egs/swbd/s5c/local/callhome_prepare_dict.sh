#!/bin/bash
#
## Initially use CMUDICT for Callhome
## Then check coverage
...
# the training data.  For purposes of aligning callhome, we want to make sure we have everything in callhome.
